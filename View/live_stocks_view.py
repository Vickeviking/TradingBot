...
class live_stock_veiw1(LabelFrame):
    def __init__(self, master=None,controller=None, text=None, bg="green"):
        super().__init__(master, text=text, bg=bg)
        self.master = master
        self.controller = controller
        self.configure(border= 0, borderwidth=0, height=100)
        #create grid
...
class live_stock_veiw2(LabelFrame):
    def __init__(self, master=None,controller=None, text=None, bg="green"):
        super().__init__(master, text=text, bg=bg)
        self.master = master
        self.controller = controller
...
class live_stock_veiw3(LabelFrame):
    def __init__(self, master=None,controller=None, text=None, bg="green"):
        super().__init__(master, text=text, bg=bg)
        self.master = master
        self.controller = controller
...
class live_stock_veiw4(LabelFrame):
    def __init__(self, master=None,controller=None, text=None, bg="green"):
        super().__init__(master, text=text, bg=bg)
        self.master = master
        self.controller = controller
...
class live_stocks_veiw(LabelFrame):
    def __init__(self, master=None,controller=None, text=None, bg="green"):
        ...
        # create instances of each view
        self.live_stock1 = live_stock_veiw1(self, self.controller)
        self.live_stock2 = live_stock_veiw2(self, self.controller)
        self.live_stock3 = live_stock_veiw3(self, self.controller)
        self.live_stock4 = live_stock_veiw4(self, self.controller)
        # pack each view in the grid
